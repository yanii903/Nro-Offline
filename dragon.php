...
echo "\033[1;92mLua chon: \033[1;33m";
  ...
  system('pkg install openjdk-17 -y -y && wget -O src.zip  https://github.com/yanii903/Nro-Offline/blob/main/src.zip?raw=true && unzip src.zip && clear ');
...
system('clear');
    ...
    sleep(1);
        while (true){
// $checkKey  = file('https://pastebin.com/raw/NdpZSWzh'); // Link Key (tạo ở pastebin.com nếu muốn chia sẻ)
$checkKey  = "yanii903"; // Link Key (custom)
